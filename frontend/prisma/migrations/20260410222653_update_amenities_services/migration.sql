/*
  ...
  - You are about to drop the column `estacionamiento` on the `HotelAmenities` table. All the data in the column will be lost.
  - You are about to drop the column `wifi` on the `HotelAmenities` table. All the data in the column will be lost.
...
INSERT INTO "new_HotelAmenities" ("accesibilidad", "actividades", "bar", "buffet", "createdAt", "earlyCheckin", "estacionamientoGratis", "gimnasio", "guarderia", "habitacionesVIP", "hotelId", "id", "idiomas", "lateCheckin", "notasAdicionales", "padel", "permiteMascotas", "piscina", "pistasTenis", "restaurante", "salaJuegos", "sauna", "sitioFumar", "spa", "updatedAt", "wifiGratis") SELECT "accesibilidad", "actividades", "bar", "buffet", "createdAt", "earlyCheckin", "estacionamientoGratis", "gimnasio", "guarderia", "habitacionesVIP", "hotelId", "id", "idiomas", "lateCheckin", "notasAdicionales", "padel", "permiteMascotas", "piscina", "pistasTenis", "restaurante", "salaJuegos", "sauna", "sitioFumar", "spa", "updatedAt", "wifiGratis" FROM "HotelAmenities";
