    ...
    <div className="min-h-screen bg-slate-900 text-white p-8">
      <header className="mb-10">
        <div className="flex justify-between items-start mb-6">
          ...
          <button
            onClick={() => router.push("/")}
            className="bg-blue-600 hover:bg-blue-500 px-4 py-2 rounded-lg font-semibold transition-all text-sm"
          >
            ← Dashboard
          </button>
        </div>
      ...
      {amenities ? (
        <>
          ...
          <div className="mt-8 flex gap-4 justify-center">
            ...
            <button
              onClick={() => router.push("/")}
              className="bg-blue-600 hover:bg-blue-500 px-6 py-3 rounded-full font-bold transition-all"
            >
              ⚡ Generar Análisis IA
            </button>
          </div>
