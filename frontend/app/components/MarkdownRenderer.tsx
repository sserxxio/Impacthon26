    ...
    <div className={`max-w-none ${className}`}>
      <ReactMarkdown
        ...
        components={{
          ...
          h2: ({ children }) => <h2 className="text-2xl font-bold italic text-inherit mb-4 uppercase tracking-tight">{children}</h2>,
          h3: ({ children }) => <h3 className="text-xl font-bold text-inherit mb-3 opacity-90">{children}</h3>,
          p: ({ children }) => <p className="mb-4 leading-relaxed text-inherit last:mb-0">{children}</p>,
          strong: ({ children }) => <strong className="font-bold text-[#5e0710] shadow-sm">{children}</strong>,
          ul: ({ children }) => <ul className="list-disc list-inside space-y-2 mb-4 text-inherit ml-4">{children}</ul>,
          ol: ({ children }) => <ol className="list-decimal list-inside space-y-2 mb-4 text-inherit ml-4">{children}</ol>,
