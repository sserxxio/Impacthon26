  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed z-[60] border border-[#ae8d6e]/40 bg-white/80 backdrop-blur-sm text-[#683110] hover:bg-[#683110] hover:text-[#f5f4f1] p-2 rounded-full transition-all shadow-md top-4 ${isOpen ? "left-56 rotate-0" : "left-4 rotate-180"
          }`}
      ...
      <aside className={`bg-white border-r border-[#ae8d6e]/20 flex flex-col h-screen sticky top-0 transition-all duration-300 z-[50] overflow-hidden ${isOpen ? "w-64 shrink-0" : "w-0 shrink-0 border-none"
        }`}>
        <div className="w-64 flex flex-col h-full p-6">
          ...
          <nav className="flex-1 space-y-2">
            ...
            <button
              ...
              className={`w-full text-left px-4 py-3 rounded-xl font-black transition-all border  border-[#ae8d6e]/30 bg-transparent text-[#683110] hover:bg-[#f5f4f1]`}
            >
              Generador contenido
            </button>
          </nav>
